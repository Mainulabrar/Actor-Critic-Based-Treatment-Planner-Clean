...
# scoreDataInitial = np.load('/data2/mainul/DataAndGraph/AllInitialScoreACERrandom6C.npy')
# scoreDataMax = np.load('/data2/mainul/DataAndGraph/AllFinalScoreACERrandom6C.npy')
...
plt.bar(bar_positions_set2, values2, width=bar_width, label='Maximum Scores', color='orange')
...
plt.legend()
plt.savefig(graphSavePath+'InitialAndFinalPlanComparisonTROTS.png', dpi = 1200)
plt.show()
# ===========================================================================
...
# # Plot the first set of bars
# plt.bar(bar_positions_set1, ScoreDistArray[:,0], width=bar_width, label='InitialScores', color='blue')
# plt.errorbar(bar_positions_set1, ScoreDistArray[:,0], yerr=ScoreDistArray[:,1], fmt='o', capsize=5, color='black')

# # Plot the second set of bars
# plt.bar(bar_positions_set2, ScoreDistArray[:,2], width=bar_width, label='Final Scores', color='orange')
# plt.errorbar(bar_positions_set2, ScoreDistArray[:,2], yerr=ScoreDistArray[:,3], fmt='o', capsize=5, color='black')



# plt.xlabel('Patient Group Index')
# plt.ylabel('Plan Scores')
# plt.title('Plan Scores vs Patient Group Index')
# # plt.legend(loc='upper left', bbox_to_anchor=(0.1, 0.9), fancybox=True, shadow=True)
# plt.legend()
# plt.ylim(0,11)
# plt.savefig(graphSavePath+'PatientIndexGraphRandom6C.png', dpi = 1200)
# plt.show()