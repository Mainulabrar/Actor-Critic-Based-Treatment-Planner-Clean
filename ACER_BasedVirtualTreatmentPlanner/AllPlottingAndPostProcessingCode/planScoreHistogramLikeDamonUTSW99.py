...
scoreDataInitial = np.load("/data2/mainul/DataAndGraph/scoreDataInitialUTSW99.npy")
scoreDataMax = np.load("/data2/mainul/DataAndGraph/scoreDataMaxUTSW99.npy")
...
plt.savefig(graphSavePath+'InitialAndFinalPlanComparisonACERUTSW99.png', dpi = 1200)
plt.show()
plt.close()
# ===========================================================================
