...
>>>>>>> c73116994303ed8bd1ac543821f1824ccc5ecea9
    ...
    while T.value() <= args.T_max:
        if can_test:
            ...
            model.load_state_dict(torch.load('/home/mainul1/Actor-critic-based-treatment-planning/acer_VTPN-12-18-23/results/results/episode120499.pth'))
            model.eval()
...
<<<<<<< HEAD
                            planscoresSavePath = '/data/mainul1/results_CORS1/scratch6_30StepsNewParamenters3/planscores/'
                            data_result_path='/data/mainul1/results_CORS1/scratch6_30StepsNewParamenters3/dataWithPlanscoreRun/'
=======
                            planscoresSavePath = '/data/mainul1/results_CORS/scratch6_30StepsNewParamenters3NewData1/planscores/'
