...
scoreDataInitial = np.load("/data2/mainul/DataAndGraph/scoreDataInitialUTSW63.npy")
scoreDataMax = np.load("/data2/mainul/DataAndGraph/scoreDataMaxUTSW63.npy")
...
plt.savefig(graphSavePath+'InitialAndFinalPlanComparisonACERUTSW63.png', dpi = 1200)
plt.show()
plt.close()
# ===========================================================================
