...
plt.plot(x_ptv, y_ptv, label='PTV Perturbed', color='blue', linestyle='-')
plt.plot(x_bladder, y_bladder, label='Bladder Perturbed', color='green', linestyle='--' )
plt.plot(x_rectum, y_rectum, label='Rectum Perturbed', color='red', linestyle=':')
...
# Plot the three datasets against the array of points
plt.plot(x_ptv, y_ptv, label='PTV', color='orange', linestyle='-')
plt.plot(x_bladder, y_bladder, label='Bladder', color='purple', linestyle='--' )
plt.plot(x_rectum, y_rectum, label='Rectum', color='cyan', linestyle=':')
...
plt.savefig('/data2/mainul/DataAndGraphDQN/FGSMPaper/AdversarialPerturbation.png', dpi = 1200)
plt.show()