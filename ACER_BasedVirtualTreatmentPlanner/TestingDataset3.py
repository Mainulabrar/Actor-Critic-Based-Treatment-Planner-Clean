                ...
                while True:
                    ...
                    if done:
                        ...
                        while (planScore >= 8.1):
                            ...
                            # # this is another very special block to get low score
                            # epsilon = 1e-10
                            # tPTV = random.uniform(0 + epsilon, 120 - epsilon)
                            # tBLA = random.uniform(0 + epsilon, 100 - epsilon)
                            # tREC = random.uniform(0 + epsilon, 100- epsilon)
                            # lambdaPTV = random.uniform(0 + epsilon, 100 - epsilon)
                            # lambdaBLA = random.uniform(0 + epsilon, 100 - epsilon)
                            # lambdaREC = random.uniform(0 + epsilon, 100 - epsilon)
                            # VPTV = random.uniform(0 + epsilon, 30 - epsilon)
                            # VBLA = random.uniform(0 + epsilon, 100 - epsilon)
                            # VREC = random.uniform(0 + epsilon, 100 - epsilon)
                            # xVec = np.ones((MPTV.shape[1],))
                            # gamma = np.zeros((MPTV.shape[0],))
                            ...
                            # #This is the Previous save path
                            # planscoresSavePath = '/data/mainul1/results_CORS/scratch6_20StepsNewParamenters3NewData4/planscores/'
                            # data_result_path='/data/mainul1/results_CORS/scratch6_20StepsNewParamenters3NewData4/dataWithPlanscoreRun/'
