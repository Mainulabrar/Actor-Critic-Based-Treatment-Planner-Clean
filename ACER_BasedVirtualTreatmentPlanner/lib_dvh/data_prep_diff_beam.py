...
def loadDoseMatrix(filename):
    test = h5sparse.File(filename,'r')
    Dmat = test['Dij']['000'].value
    temp = test['Dij']['060'].value
    Dmat = vstack([Dmat, temp])
    temp = test['Dij']['120'].value
    Dmat = vstack([Dmat, temp])
    temp = test['Dij']['180'].value
    Dmat = vstack([Dmat, temp])
    temp = test['Dij']['240'].value
    Dmat = vstack([Dmat, temp])
    temp = test['Dij']['300'].value
    Dmat = vstack([Dmat, temp])
    Dmat = Dmat.transpose()
    # print("Dmat", Dmat)
...
# def loadDoseMatrix(filename):
#     test = h5sparse.File(filename,'r')
#     Dmat = test['Dij']['026'].value
#     temp = test['Dij']['076'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['130'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['180'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['230'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['286'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['336'].value
#     Dmat = vstack([Dmat, temp])
#     Dmat = Dmat.transpose()
#     # print("Dmat", Dmat)
#     # print("Dmat.shape", Dmat.shape)
...
#20 degrees, 70 degrees, 110 degrees, 150 degrees, 200 degrees, 250 degrees, 290 degrees, 340 degrees

# def loadDoseMatrix(filename):
#     test = h5sparse.File(filename,'r')
#     Dmat = test['Dij']['020'].value
#     temp = test['Dij']['070'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['110'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['150'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['200'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['250'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['290'].value
#     Dmat = vstack([Dmat, temp])
#     temp = test['Dij']['340'].value
#     Dmat = vstack([Dmat, temp])
#     Dmat = Dmat.transpose()
#     # print("Dmat", Dmat)
#     # print("Dmat.shape", Dmat.shape)
