            ...
            for patientid in range(len(pid)):
                ...
                while True:
                    ...
                    if done:
                        ...
                        # planscoresSavePath = '/data2/mainul/results_CORS1PaperDiffBeam/scratch6_30StepsNewParamenters3NewData1/planscores/'
                        ...
                        # planscoresSavePath = '/data2/mainul/results_CORS1PaperDiffBeam7/scratch6_30StepsNewParamenters3NewData1/planscores/'
                        # os.makedirs(planscoresSavePath, exist_ok = True)
                        # data_result_path='/data2/mainul/results_CORS1PaperDiffBeam7/scratch6_30StepsNewParamenters3NewData1/dataWithPlanscoreRun/'
                        # os.makedirs(data_result_path, exist_ok = True)

                        # planscoresSavePath = '/data2/mainul/results_CORS1PaperDiffBeam8/scratch6_30StepsNewParamenters3NewData1/planscores/'
                        # os.makedirs(planscoresSavePath, exist_ok = True)
                        # data_result_path='/data2/mainul/results_CORS1PaperDiffBeam8/scratch6_30StepsNewParamenters3NewData1/dataWithPlanscoreRun/'
                        # os.makedirs(data_result_path, exist_ok = True)

                        planscoresSavePath = '/data4/mainul/results_CORS1PaperDiffBeam6/scratch6_30StepsNewParamenters3NewData1/planscores/'
                        os.makedirs(planscoresSavePath, exist_ok = True)
                        data_result_path='/data4/mainul/results_CORS1PaperDiffBeam6/scratch6_30StepsNewParamenters3NewData1/dataWithPlanscoreRun/'
                        os.makedirs(data_result_path, exist_ok = True)
...
TELEGRAM_BOT_TOKEN = "*RandomTelegramToken*"  # Your Telegram bot token
