...
import time
from dataPrepDataset2 import loadDoseMatrix,loadMask,ProcessDmat
from gym import Env
...
def test(rank, args, T):
    ...
    # This block is for testing with the CORT dataset
                ...
                while True:
                    if done:
                        ...
                        while (planScore > 4):
                            ...
                            planscoresSavePath = '/data2/mainul1/results_CORS/scratch6_30StepsNewParamenters3indCriTime/planscores/'
                            data_result_path='/data2/mainul1/results_CORS/scratch6_30StepsNewParamenters3indCriTime/dataWithPlanscoreRun/'
